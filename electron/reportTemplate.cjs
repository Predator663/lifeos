// electron/reportTemplate.cjs — builds the printable HTML for the finance
// PDF export. Deliberately plain HTML/CSS/inline-SVG, no React: it's
...
module.exports = { buildFinanceReportHtml }
